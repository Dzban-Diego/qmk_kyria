...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYS_NAV] = LAYOUT(
	    ...
	    TG(7)        , RGUI(KC_1)   , RGUI(KC_2)   , RGUI(KC_3)   , RGUI(KC_4)   , RGUI(KC_5)   , /*===========, =============, =============, ============*/ KC_PGDN      , KC_HASH      , KC_EQUAL    , KC_RABK       , KC_MINUS     , KC_BSPC      ,
	...
	[_MED] = LAYOUT(
	    ...
	    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, /*====*/ KC_NO, KC_NO, SGUI(KC_PGDN),KC_MPRV, KC_MPLY, KC_MNXT, KC_BRID, KC_PSCR,
