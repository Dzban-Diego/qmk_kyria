...
// MEDIA
	[_MED] = LAYOUT(
        ...
        /*=====, =======, ======*/ XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, XXXXXXX, KC_TRNS  /*=====, =======, ======*/
    ),
...
// Nawigxacja
	...
	[_NUM] = LAYOUT(
	    ...
	    XXXXXXX, XXXXXXX, KC_PCMM, KC_PDOT, KC_PEQL, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_1   , KC_2   , KC_3   , XXXXXXX, KC_ENT ,
    ...
    [_num] = LAYOUT(
        ...
        /*=====, =======, ======*/ TG(0)  , XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX  /*=====, =======, ======*/
    ),
};
